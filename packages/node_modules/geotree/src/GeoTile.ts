...
export interface NearestState {
	...
	e: number;
	result: any;
	/** Distance or squared distance, depending on tile implementation. */
	dist: number;
}

export class GeoTile extends QuadTile implements TileGeometry {
	...
	getGeometry() {
		return({
			then: ((fn: (geometry: TileGeometry) => any) => fn(this) as Promise<TileGeometry>)
		});
	}
