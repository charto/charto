...
export class ConfigGML implements OptionsGML {
	...
	constructor(options: OptionsGML) {
		...
		this.xmlConfig.jsxRegister({ gml }, ({ gml }) => {
			...
			element[cgeo.GeometryKind.compoundCurve] = gml.Curve;
			...
			member[cgeo.GeometryKind.compoundCurve] = gml.segments;
			...
			geometry[gml.Curve.id!] = cgeo.CompoundCurve;
			...
			geometry[gml.LineStringSegment.id!] = cgeo.LineString;
