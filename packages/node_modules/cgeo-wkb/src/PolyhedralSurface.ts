...
export class PolyhedralSurface extends cgeo.PolyhedralSurface {
	...
	measureWKB(state: State) {
		return(cgeo.MultiSurface.prototype.measureWKB.call(this, state));
	}

	writeWKB(state: State) {
		return(cgeo.MultiSurface.prototype.writeWKB.call(this, state));
	}

	readWKB(state: State) {
		return(cgeo.MultiSurface.prototype.readWKB.call(this, state));
	}
