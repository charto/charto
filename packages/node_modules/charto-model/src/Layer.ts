...
import { types as T, IModelType, ISnapshottable, IComplexType } from 'mobx-state-tree';
...
console.log(Layer.create({ children: [ { children: [ { name: 'FOO' } ] } ] }).children![0].children![0].name);
