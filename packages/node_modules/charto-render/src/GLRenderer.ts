...
export class GLRendererState extends RendererState {
	...
	constructor(public options: RendererOptions) {
		...
		const margin = this.pixelRatio * this.radius;
		...
		this.offsetX = -w * this.scaleX + margin * 2 / this.fullWidthPixels - 1;
		this.offsetY = -n * this.scaleY - margin * 2 / this.fullHeightPixels + 1;
	}
